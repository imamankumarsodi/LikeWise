...
extension CurrentVC{
    ...
    internal func initialSetup(){
        ...
        NotificationCenter.default.addObserver(self,selector:#selector(CurrentVC.reloadTable(_:)),name:NSNotification.Name(rawValue: "TBL_RELOAD"),object: nil)
        
        if (UserDefaults.standard.value(forKey: "IS_GUEST") as? Bool) != nil{
            chatUserListCurrentApi(true)
        }
