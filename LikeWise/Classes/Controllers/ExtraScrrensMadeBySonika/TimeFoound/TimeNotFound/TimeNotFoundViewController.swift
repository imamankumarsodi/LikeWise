//
//  TimeNotFoundViewController.swift
//  LikeWise
//
...
class TimeNotFoundViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        CustomMethods.shared.provideShadowAndCornerRadius(self.inviteFriendBtn, 20.0, AppColor.textColor, 5, 5, 0.5, 10, 0, AppColor.clearColor)
        
        CustomMethods.shared.provideShadowAndCornerRadius(self.homeBtn, 20.0, AppColor.textColor, 5, 5, 0.5, 10, 0, AppColor.clearColor)
    ...
    @IBAction func inviteFriendBtnAction(_ sender: Any) {
        ...
        CustomMethods.shared.playSound("enter_chat.mp3")
...
extension TimeNotFoundViewController{
