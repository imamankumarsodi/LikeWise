//
//  GameDescriptionExtensionMethod.swift
//  LikeWise
//
...
extension GameStartingViewController{
   ...
   internal func initialSetup(){
    ...
    CustomMethods.shared.setupTextFeild(messageTf, UIColor.black, AppFont.light.size(AppFontName.SegoeUI, size: 12.0), AppColor.chatTfColor,"", .default)
     ...
     CustomMethods.shared.setupLabel(decsribeLbl, AppColor.themeColorLight, AppFont.semibold.size(AppFontName.SegoeUI, size: 14.0), "Describe", AppColor.clearColor)
    
    CustomMethods.shared.setupLabel(describeTypeLbl, AppColor.textColor, AppFont.light.size(AppFontName.SegoeUI, size: 12.0), "What do we see?", AppColor.clearColor)
    
    CustomMethods.shared.setupLabel(describeDesLbl, AppColor.placeholderColor, AppFont.light.size(AppFontName.SegoeUI, size: 14.0), "The icon depicrs the instrucions category(Describe,Name,Converse,Solve)", AppColor.clearColor)
...
extension GameStartingViewController:UITableViewDataSource,UITableViewDelegate{
