...
extension LoginVC{
    ...
    internal func initialSetup(){
        ...
        CustomMethods.shared.setupButton(btnLoginRef, AppColor.textColor,AppColor.clearColor,ConstantFonts.TextFieldFont, ConstantTexts.LoginLT)
        viewLoginUL.backgroundColor = AppColor.placeholderColor
        
        CustomMethods.shared.setupButton(btnRegisterRef, AppColor.placeholderColor,AppColor.clearColor,ConstantFonts.TextFieldFont, ConstantTexts.RegisterLT)
        viewRegisterUL.backgroundColor = AppColor.clearColor
        ...
        txtMail.placeholder = ConstantTexts.emailUserNamePH
        txtMail.keyboardType = .default
        ...
        CustomMethods.shared.setupButton(btnForgotRef, AppColor.placeholderColor,AppColor.clearColor,AppFont.semibold.size(AppFontName.SegoeUI, size: 16.0), ConstantTexts.forgetPassBT)
        
        CustomMethods.shared.setupButton(btnLoginNewRef, AppColor.themeColorDark,AppColor.whiteColor, ConstantFonts.TextFieldFont, ConstantTexts.LoginLT)
...
extension LoginVC:UITextFieldDelegate{
    func textFieldDidBeginEditing(_ textField: UITextField) {
        if textField == txtMail{
            CustomMethods.shared.showSelectUnselectTextFields(true, [viewMail,viewPassword])
        }else{
            CustomMethods.shared.showSelectUnselectTextFields(true, [viewPassword,viewMail])
        }
    }
    
    
    func textFieldDidEndEditing(_ textField: UITextField) {
        CustomMethods.shared.showSelectUnselectTextFields(false, [viewMail,viewPassword])
    }
...
extension LoginVC{
    ...
    internal func hitLogInApi(){
        ...
        SAuthService().postService(parameters: userModel.toJSON(), serviceName: SAuthApi.login, header: headers).done{(response) -> Void  in
