...
class MyMessageTableViewCell: BaseTableViewCell {
    ...
    internal func setupCell(){
        ...
        CustomMethods.shared.provideCornerRadiusTo(self.viewBg, 20,[.layerMinXMinYCorner,.layerMaxXMinYCorner, .layerMinXMaxYCorner])
        viewBg.alpha = 0.80
        lblMessage.numberOfLines = 0
        lblMessage.font = AppFont.semibold.size(AppFontName.SegoeUI, size: 13.0)
